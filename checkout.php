...
<body>
 ...
 do navbar-static-top o navbar-fixed-top que mantém o menu fixo na tela e depois aplica um paddind de 70px no body para o conteúdo não subir-->
  <div class="navbar-header">
    <a class="navbar-brand" href="index.php">Brinquedos</a> <!-- em vez de um texto no link você pode usar uma imagem -->
 ...
 <div class="container">
  <h1>Ótima escolha!</h1>
  <p>Obrigado por comprar na Brinquedos!
...
<img src="img/produtos/foto<?= $_POST["id"] ?>-<?= $_POST["cor"] ?>.png" 
  ...
  <div class="checkbox">
    <label>
      ...
      Quero receber spam da Brinquedos
    </label>
  </div>
  </fieldset>
